...
static std::string cell_name(TTacCell const &cell) {
  switch (cell) {
  case TTAC_TOP: return "TOP";
  case TTAC_LEFT: return "LEFT";
  case TTAC_RIGHT: return "RIGHT";
  case TTAC_BOTTOM: return "BOTTOM";
  case TTAC_TOP_LEFT: return "TOP LEFT";
  case TTAC_TOP_RIGHT: return "TOP RIGHT";
  case TTAC_BOTTOM_RIGHT: return "BOTTOM RIGHT";
  case TTAC_BOTTOM_LEFT: return "BOTTOM LEFT";
  case TTAC_CENTER: return "CENTER";
...
GEN_DUAL_FUNC(ADJ_GEN_ADJ);
GEN_DUAL_FUNC(OPP_GEN_ADJ);
